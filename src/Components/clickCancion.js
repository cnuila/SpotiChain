            ...
            <div className="bg-gray-900 h-screen w-screen">
                ...
                <div className="grid grid-cols-8">
                    ...
                    <div className="col-span-7">
                        <div className="pl-28 pt-16 inline-flex pb-8 h-1/2 w-full object-cover">
                            ...
                            <div className="pt-20 pl-4">
                                ...
                                <div className="pt-1 text-white text-5xl font-sans">
                                    Dreams
                        </div>
                                <div className="inline-flex text-lg font-sans">
                                    <div className="pt-1 pr-2 text-gray-400 text-lg font-sans">
                                        By
                            </div>
                                    <div className="pt-1 text-indigo-700 text-lg font-sans">
                                        Michael Jackson
                            </div>
                                </div>
                                ...
                                <button class="mr-8 bg-transparent hover:bg-blue-700 text-blue-700 font-semibold hover:text-white py-2 px-8 border border-blue-700 hover:border-white rounded-full">
                                    Play
                            </button>
