...
export default class Agregar extends Component {
    ...
    handleSubmit = (e) => {
        e.preventDefault()
        console.log("agregar",this.state.canciones)
    }
    ...
    render() {
        ...
        return (
            <form onSubmit={this.handleSubmit}>
                <div className="grid bg-gray-900 place-items-center min-h-screen max-h-screen">
                    <div className="grid grid-cols-1 md:grid-cols-3 bg-gray-500 p-2 lg:p-5 h-full rounded-xl w-10/12 sm:w-8/12 lg:w-9/12">
                        <div className="bg-gray-900">
                            ...
                            <div className="flex flex-row bg-gray-900 mx-5 my-3 text-white focus-within:text-gray-400">
                                ...
                                <input className="block bg-gray-900 text-sm font-semibold border-b-2 placeholder-white focus:placeholder-gray-400 border-gray-900 focus:border-gray-400 py-1 pt-4 mr-3 mb-2 w-11/12 focus:outline-none" name="nombreAlbum" type="text" placeholder="Nombre del Álbum" required></input>
                            </div>

                            <div className="flex bg-blue-900 hover:bg-blue-800 rounded-3xl m-4 mt-5 h-12 items-center shadow-lg cursor-pointer">
