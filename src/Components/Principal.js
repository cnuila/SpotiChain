                    ...
                    <div className="bg-gray-800 w-full col-span-1 min-h-screen">
                        ...
                        <div className="py-4 pt-16">
                            ...
                            <div onClick={() => this.handlePrincipal(1)} className="group flex content-cover pb-4 pl-4 text-gray-400 cursor-default border-transparent">
                                <svg className="h-6 w-6 inline-flex mr-2 mb-2 fill-current text-gray-400 group-hover:text-white" height="512pt" viewBox="0 0 512 512" width="512pt" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div onClick={() => this.handlePrincipal(2)} className="group flex content-cover pb-4 pl-4 text-gray-400 cursor-default border-transparent" >
                                <svg className="h-6 w-6 inline-flex mr-2 fill-current text-gray-400 group-hover:text-white" height="512" viewBox="0 0 511.334 511.334" width="512" xmlns="http://www.w3.org/2000/svg">
